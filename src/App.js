                      ...
                      {memoFileUrl ? (
                        <div className="mb-6 relative rounded-3xl overflow-hidden shadow-md border border-slate-200 dark:border-slate-700 bg-slate-100 dark:bg-slate-900">
                          ...
                          {isAdmin && (
                            <button onClick={() => { 
                              setMemoFileUrl(null);
                              setMemoFileType(null); 
                              saveToFirebase({ memoFileUrl: null, memoFileType: null });
                            }} className="absolute top-4 right-4 bg-red-500 text-white p-3 rounded-2xl shadow-lg hover:bg-red-600 active:scale-90 transition-all">
                              <Trash2 size={20}/>
                            </button>
                          )}
                        </div>
                            ...
                            <div className="h-full flex flex-col">
                             ...
                             <textarea 
                                ...
                                onChange={(e) => {
                                  ...
                                  saveToFirebase({ memoText: e.target.value });
                                }} 
